...
<body class="bg-gray d-flex flex-column">
                            ...
                            <div class="tickercontainer" style="height: 25px; overflow: hidden;">
                                <div class="mask">
                                    <ul id="news-ticker-foot"
                                        style="padding: 0px; margin: 0px; position: relative; overflow: hidden; float: left; font: bold 10px Verdana; list-style-type: none; width: 1201.29px; transition-timing-function: linear; transition-duration: 15.7769s; left: -853.75px;">
                                        ...
                                        <form id="BetFilterForm" class="form-inline" method="get">
                                            <div class="form-group mrgleft">
                                                <select class="form-control" id="EventTypeId" name="EventTypeId">
                                                    ...
                                                    <option value="7">Horse Race</option>
                    ...
                    <div class="table-wrap">
                        <div class="">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>
                                        <a href="/Customer/StarOrders">Star Casino</a>
                                    </p>
                                    <div id="tableLedger_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="dataTables_length" id="tableLedger_length"><label>Show
                                                        <select name="tableLedger_length" aria-controls="tableLedger"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div id="tableLedger_filter" class="dataTables_filter">
                                                    <label>Search:<input type="search"
                                                            class="form-control form-control-sm" placeholder=""
                                                            aria-controls="tableLedger"></label></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="tableLedger"
                                                    class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-none"
                                                    style="width: 100%;" role="grid"
                                                    aria-describedby="tableLedger_info">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="tableLedger" rowspan="1" colspan="1"
                                                                style="width: 67.75px;" aria-sort="ascending"
                                                                aria-label="#: activate to sort column descending">#
                                                            </th>
                                                            <th class="sorting" tabindex="0" aria-controls="tableLedger"
                                                                rowspan="1" colspan="1" style="width: 122.75px;"
                                                                aria-label="Event: activate to sort column ascending">
                                                                Event</th>
                                                            <th class="sorting" tabindex="0" aria-controls="tableLedger"
                                                                rowspan="1" colspan="1" style="width: 142.75px;"
                                                                aria-label="Runner: activate to sort column ascending">
                                                                Runner</th>
                                                            <th class="sorting" tabindex="0" aria-controls="tableLedger"
                                                                rowspan="1" colspan="1" style="width: 118.75px;"
                                                                aria-label="Price: activate to sort column ascending">
                                                                Price</th>
                                                            <th class="sorting" tabindex="0" aria-controls="tableLedger"
                                                                rowspan="1" colspan="1" style="width: 151.75px;"
                                                                aria-label="Amount: activate to sort column ascending">
                                                                Amount</th>
                                                            <th class="sorting" tabindex="0" aria-controls="tableLedger"
                                                                rowspan="1" colspan="1" style="width: 158.75px;"
                                                                aria-label="Position: activate to sort column ascending">
                                                                Position</th>
                                                            <th class="sorting" tabindex="0" aria-controls="tableLedger"
                                                                rowspan="1" colspan="1" style="width: 139.75px;"
                                                                aria-label="Placed: activate to sort column ascending">
                                                                Placed</th>
                                                            <th class="sorting" tabindex="0" aria-controls="tableLedger"
                                                                rowspan="1" colspan="1" style="width: 157px;"
                                                                aria-label="Updated: activate to sort column ascending">
                                                                Updated</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-5">
                                                <div class="dataTables_info" id="tableLedger_info" role="status"
                                                    aria-live="polite">Showing 0 to 0 of 0 entries</div>
                                            </div>
                                            <div class="col-sm-12 col-md-7">
                                                <div class="dataTables_paginate paging_simple_numbers"
                                                    id="tableLedger_paginate">
                                                    <ul class="pagination">
                                                        <li class="paginate_button page-item previous disabled"
                                                            id="tableLedger_previous"><a href="#"
                                                                aria-controls="tableLedger" data-dt-idx="0" tabindex="0"
                                                                class="page-link">Previous</a></li>
                                                        <li class="paginate_button page-item next disabled"
                                                            id="tableLedger_next"><a href="#"
                                                                aria-controls="tableLedger" data-dt-idx="1" tabindex="0"
    ...
    <script defer=""
        ...
        data-cf-beacon="{&quot;rayId&quot;:&quot;99ac0faf5f8ffdb0&quot;,&quot;serverTiming&quot;:{&quot;name&quot;:{&quot;cfExtPri&quot;:true,&quot;cfEdge&quot;:true,&quot;cfOrigin&quot;:true,&quot;cfL4&quot;:true,&quot;cfSpeedBrain&quot;:true,&quot;cfCacheStatus&quot;:true}},&quot;version&quot;:&quot;2025.9.1&quot;,&quot;token&quot;:&quot;412e616bee9c418bbf775c35ab07c6d0&quot;}"
