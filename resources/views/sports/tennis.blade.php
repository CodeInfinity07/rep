    ...
    <script>
        ...
        function loadMatches() {
            $.get('/api/cricket-matches', function(data) {
                ...
                if (matches.length === 0) {
                    container.html('<p>No tennis matches available at the moment.</p>');
                    return;
                }
                
                container.html(matches.map(match => {
                    const runners = match.runners || [];
                    const r1 = runners[0] || {};  // Player 1
                    const r2 = runners[1] || {};  // Player 2
                    const r3 = {}; // Tennis has only 2 runners
