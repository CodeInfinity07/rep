                                            ...
                                            <div id="horsenhound" class="">
                                                ...
                                                <div class="row games_slider_container">
                                                    <div class="games_slider">
                                                        @if(isset($casinoGames) && count($casinoGames) > 0)
                                                            @foreach($casinoGames as $game)
                                                                @if(!empty($game['gmid']) && !empty($game['imgpath']))
                                                                <div class="image">
                                                                    <a href="/Common/RSC?id={{ $game['gmid'] }}&d=d">
                                                                        <img class="img-fluid img-thumbnail" src="/img/casino-games/{{ $game['imgpath'] }}" alt="{{ $game['gname'] ?? 'Casino Game' }}" loading="lazy">
                                                                    </a>
                                                                </div>
                                                                @endif
                                                            @endforeach
                                                        @else
                                                            <div class="text-center p-3" style="color: #fff;">Loading casino games...</div>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
